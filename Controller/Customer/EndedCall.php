 ...
 */
class EndedCall implements HttpGetActionInterface, CustomerSupportControllerInterface
{
    protected const PAGE_TITLE = "Support Video Call was ended";
    ...
    /**
     * Display the page for customer when call was ended
