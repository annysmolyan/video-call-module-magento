 ...
 */
class History implements HttpGetActionInterface, ManagerAccountControllerInterface
{
    protected const PAGE_TITLE = "Call History | Manager Account";
    ...
    /**
     * Show manager call history page
