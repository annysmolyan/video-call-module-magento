 ...
 */
class Settings implements HttpGetActionInterface, ManagerAccountControllerInterface
{
    protected const PAGE_TITLE = "Settings | Manager Account";
