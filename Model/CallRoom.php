 ...
 */
class CallRoom extends AbstractModel implements CallRoomInterface, IdentityInterface
{
    const CACHE_TAG = "belsmol_videocall_call_room";
    protected $_eventPrefix = "belsmol_videocall_call_room_event";
    ...
    {
       return (string)$this->getData(self::ROOM_ID);
    }
    ...
    {
        $website = $this->getData(self::WEBSITE_ID);
        return (null == $website) ? null : (int)$website;
    }
